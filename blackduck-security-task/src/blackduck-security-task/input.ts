...
export const POLARIS_FIXPR_CREATE_SINGLE_PR = getInput(
  constants.POLARIS_FIXPR_CREATE_SINGLE_PR_KEY,
  constants.POLARIS_FIXPR_CREATE_SINGLE_PR_KEY_CLASSIC_EDITOR,
  null
);
...
export const POLARIS_FIXPR_UPGRADE_GUIDANCE = getDelimitedInput(
  constants.POLARIS_FIXPR_UPGRADE_GUIDANCE_KEY,
  constants.POLARIS_FIXPR_UPGRADE_GUIDANCE_KEY_CLASSIC_EDITOR,
  null
);
