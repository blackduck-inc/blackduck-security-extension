...
export const POLARIS_FIXPR_FILTER_ISSUETYPES = getDelimitedInput(
  constants.POLARIS_FIXPR_FILTER_ISSUETYPES_KEY,
  constants.POLARIS_FIXPR_FILTER_ISSUETYPES_KEY_CLASSIC_EDITOR,
  null
);

export const POLARIS_FIXPR_FILTER_CONFIDENCE = getDelimitedInput(
  constants.POLARIS_FIXPR_FILTER_CONFIDENCE_KEY,
  constants.POLARIS_FIXPR_FILTER_CONFIDENCE_KEY_CLASSIC_EDITOR,
  null
);

export const POLARIS_PR_COMMENT_FILTER_ISSUETYPES = getDelimitedInput(
  constants.POLARIS_PR_COMMENT_FILTER_ISSUETYPES_KEY,
  constants.POLARIS_PR_COMMENT_FILTER_ISSUETYPES_KEY_CLASSIC_EDITOR,
  null
);
