...
export enum ErrorCode {
  ...
  BLACKDUCKSCA_FIXPR_MAXCOUNT_NOT_APPLICABLE = 104,
  INVALID_POLARIS_ASSESSMENT_TYPES = 105,
  INVALID_BLACKDUCKSCA_FAILURE_SEVERITIES = 106,
  INVALID_BLACKDUCKSCA_FIXPR_MAXCOUNT = 107,
  MISSING_BOOLEAN_VALUE = 108,
  INVALID_BRIDGE_CLI_URL = 109,
  BRIDGE_CLI_URL_CANNOT_BE_EMPTY = 110,
  INVALID_URL = 111,
  BRIDGE_CLI_VERSION_NOT_FOUND = 112,
  BRIDGE_CLI_DOWNLOAD_FAILED = 113,
  ...
  POLARIS_FIXPR_MAXCOUNT_NOT_APPLICABLE = 127,
  INVALID_POLARIS_FIXPR_MAXCOUNT = 128,
